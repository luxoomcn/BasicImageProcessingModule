...
namespace BaicImageProcessModule
{
    ...
    public class MathMorphologyForm : System.Windows.Forms.Form
    {
        ...
        private BaicImageProcessModule.GridArrayInt grid;
        ...
        private void InitializeComponent( )
        {
            ...
            this.grid = new BaicImageProcessModule.GridArrayInt( );
            ...
            this.grid.ValueChanged += new BaicImageProcessModule.GridArrayInt.GridEventHandler( this.grid_ValueChanged );
            // 
            // sizeCombo
            // 
        ...
        private void grid_ValueChanged( object sender, BaicImageProcessModule.GridEventArgs e )
        {
            UpdateFilter( );
        }
